...
- 同步 148—150 Cordis / DeepSeek Harness 三篇到公开博客，分别设置 `publishAt` 为 2026-08-27 19:00、2026-08-30 19:00、2026-09-02 19:00；公众号链接待正式发出后回填。封面与正文解释图已从 `writing-craft` 转为 WebP 后入库，文章 URL 使用纯语义 slug。
