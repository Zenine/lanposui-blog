...
- 补齐 / 更正全部 8 篇文章的公众号原文链接（`wechat` 字段），链接由本人从公众号后台提供、并经页面 `og:title` 与 `createTime` 逐条比对确认：001、004、005 为新增，002 由二维码短链 `weixin.qq.com/r/mp/...` 换为标准文章链接，2021《从元开始》由带 `__biz` 的长参数链接换为短链，2022《重拾写作 1》与 2023《ChatGPT：都什么年代，谁在搞传统 NLP？》为新增。003 的公众号链接仍缺，待补。
- **第 001 期 `date` 由 `2026-07-30` 更正为 `2026-07-24`**：公众号页面实测发送时间为 2026-07-24 20:42。此前本仓记 07-30、`writing-craft` 记 07-18（实为「与 002 合发准备」的计划日），三处互不一致；经用户裁决统一以平台实测时间为准，`writing-craft` 侧文件名与 `published_at` 已同步更正。**注意**：第 003 期本仓记 `2026-08-01`、`writing-craft` 记 `2026-07-31`，同类不一致仍在，待其公众号链接到手后核对。
